...
CREATE PROCEDURE GetProductById(IN pProductId INT, OUT pProductLevel VARCHAR(20))

BEGIN
	DECLARE VALOR DECIMAL(10,2) DEFAULT 0;
    SELECT COUNT(*) INTO VALOR FROM PRODUTO as P WHERE P.COD_PRODUTO = pProductId;
